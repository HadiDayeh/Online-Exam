...
<body class="bg-pattern">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <form id="student_login_form">
                    ...
                    <!-- Form Title -->
                    <h3 class="text-center mt-0 mb-20">Student Login</h3>
                ...
                <p class="help-block mt-10 mb-0">
                    <!-- Create account -->
                    <a href="/student/pages/register.php" class="pull-left">Create Account</a>

                    <!-- Switch to Instructor -->
                    <a href="/instructor/pages/login.php" class="pull-right">Login as Instructor</a>
                </p>
    ...
    <script src="/student/js/login.js"></script>
